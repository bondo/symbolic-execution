...
\item \todo{Ideally, how would we choose the types of input
  parameters? By adding some sort of type constraints? By trying every
  combination? By having the user specify the types to test?}
\end{itemize}
